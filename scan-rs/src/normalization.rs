    ...
    M: MatrixMap<u32, u32>,
{
    ...
    match norm {
        ...
        CellRanger8 => {
            // TODO(lhepler): fix the opaque types issue and this can become .center(Axis(1), None)
        ...
        // FIXME (joey.arthur): these functions return a different opaque type, so this is going to
        //   require some factoring. lance.hepler: we may want to make a trait that covers a lot of
